...
let nums = [45,35,38,13,12,23,48,15,44,21,43,26,6,37,19,22,18,11,32,4,16,28,49,29,36,33,8,9,39,46,17,41,7,2,5,27,20,40,34,30,25,47,0,31,42,24,10,14]
console.log(JSON.stringify(missingNumber(nums)))

// let nums = [1,3,5];
// res = nums.length;
// res = res ^ 0 ^ nums[0]^ 1 ^ nums[1]^ 2 ^ nums[2];
// console.log(res)