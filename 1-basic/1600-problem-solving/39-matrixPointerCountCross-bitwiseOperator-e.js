/**
 ...
 Wr just need to know the operation count for every row and column,
 and based on that, we can calculate wether each cell is odd.

 Traversal the indices and counting for every row and column
 Traversal all the cells and check wether the value is odd
 */
  ...
  * @returns {number}
  */
 const oddCells2 = (row, column, indices) => {
